 ...
 *
 * @package   MSProductAddons_Template_Loader
 * @author    Gary Jones
 * @link      http://github.com/GaryJones/MSProductAddons-Template-Loader
 * @copyright 2013 Gary Jones
 * @license   GPL-2.0-or-later
 * @version   1.3.1
 */

if (!class_exists('MSProductAddons_Template_Loader')) {
	 ...
	 * @author  Gary Jones
	 */
	class MSProductAddons_Template_Loader {
		/**
		 ...
		 * @var string
		 */
		protected $theme_template_directory = 'mspa';
		 ...
		 * @var string
		 */
		protected $plugin_directory = MSProductAddons_DIR;
		 ...
		 *                         Default is 'data'.
		 * @return MSProductAddons_Template_Loader
		 */
